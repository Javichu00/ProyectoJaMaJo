...
CREATE TABLE IF NOT EXISTS Contenido (
    ...
    descripcion         TEXT,
    fecha               DATE,
    clasificacion_edad  ENUM('TP', 'PLUS_7', 'PLUS_13', 'PLUS_16', 'PLUS_18') NOT NULL,
    CONSTRAINT fk_contenido_director
...
CREATE TABLE IF NOT EXISTS Resena (
    ...
    CONSTRAINT fk_resena_contenido
        FOREIGN KEY (id_contenido)
        REFERENCES Contenido(id_contenido)
        ON DELETE CASCADE,
